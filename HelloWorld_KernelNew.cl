...
__kernel void compute_distance(__global float *distance, __global Ray *rays, int ray_id, __global float *directions, float3 origin, __global Object *objects, int nb_objects, int time)
{
